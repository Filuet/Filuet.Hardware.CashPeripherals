...
namespace Filuet.Hardware.CashAcceptors.Periphery.ITL
{
    public class CHelpers
    {
        ...
        /// <returns></returns>
        static public int ConvertBytesToInt32(byte[] b, int index) => BitConverter.ToInt32(b, index);
        ...
        /// <param name="index"></param>
        /// <returns></returns>
        static public int ConvertBytesToInt16(byte[] b, int index) => BitConverter.ToInt16(b, index);
        ...
        /// <param name="n"></param>
        /// <returns></returns>
        static public byte[] ConvertIntToBytes(int n) => BitConverter.GetBytes(n);
        ...
        /// <param name="n"></param>
        /// <returns></returns>
        static public byte[] ConvertIntToBytes(short n) => BitConverter.GetBytes(n);
        ...
        /// <param name="n"></param>
        /// <returns></returns>
        static public byte[] ConvertIntToBytes(char n) => BitConverter.GetBytes(n);
